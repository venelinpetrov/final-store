...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}  Final Store - Development Mode${NC}"
echo -e "${GREEN}========================================${NC}"
echo ""
...
if [ $? -eq 0 ]; then
    ...
    echo -e "Debug port: ${GREEN}5005${NC}"
    echo ""
    echo -e "${YELLOW}Hot Reload Enabled:${NC}"
    echo -e "  - Make changes to your Java files"
    echo -e "  - Spring Boot DevTools will automatically restart"
    echo -e "  - Refresh Swagger to see your changes"
    echo ""
    echo -e "To view logs: ${YELLOW}docker-compose -f docker-compose.dev.yml logs -f app${NC}"
